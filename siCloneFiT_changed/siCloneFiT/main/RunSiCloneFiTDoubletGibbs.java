 ...
 * Oct 19, 2017
 */
public class RunSiCloneFiTDoubletGibbs {
...
//        	double nuLikelihood = CLObj.ampErrLikelihoodObj.computeAmpErrorLogLikelihoodCellMatrixDoubletFpFn(listSingleCells, listClone, c2CellCloneList, cellDoubletFlagArr, currFp, currFn, nMut, SCF, dataFlag);
//        	System.out.println("main indicator updated, likelihood = " + nuLikelihood);
...
//        	nuLikelihood = CLObj.ampErrLikelihoodObj.computeAmpErrorLogLikelihoodCellMatrixDoubletFpFn(listSingleCells, listClone, c2CellCloneList, cellDoubletFlagArr, currFp, currFn, nMut, SCF, dataFlag);
//        	System.out.println("2nd indicator updated, likelihood = " + nuLikelihood);
...
//        	nuLikelihood = CLObj.ampErrLikelihoodObj.computeAmpErrorLogLikelihoodCellMatrixDoubletFpFn(listSingleCells, listClone, c2CellCloneList, cellDoubletFlagArr, currFp, currFn, nMut, SCF, dataFlag);
//        	System.out.println("clonal genotypes updated, likelihood = " + nuLikelihood);
...
//        	nuLikelihood = CLObj.ampErrLikelihoodObj.computeAmpErrorLogLikelihoodCellMatrixDoubletFpFn(listSingleCells, listClone, c2CellCloneList, cellDoubletFlagArr, currFp, newFn, nMut, SCF, dataFlag);
        	...
        	currFn = newFn;
//        	System.out.println("Fn updated, likelihood = " + nuLikelihood);
...
//        	System.out.println("Fp updated, likelihood = " + nuLikelihood);
...
//        	int[] copyCellDoubletFlagArr = SCF.getCopyCellDoubletFlagArr(cellDoubletFlagArr);
        	...
        	double nuLikelihood = CLObj.ampErrLikelihoodObj.computeAmpErrorLogLikelihoodCellMatrixDoubletFpFn(listSingleCells, listClone, c2CellCloneList, cellDoubletFlagArr, currFp, currFn, nMut, SCF, dataFlag);
        	System.out.println("likelihood = " + nuLikelihood);
        	
        	if (nuLikelihood > bestL){
        		bestL = nuLikelihood;
        		bestClone = listClone;
        		bestTree = currTree;
        		bestFn = currFn;
